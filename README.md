...
These resources will be hosted on the Content Management System (CMS) Contentful (Google Cloud), site generated using the static site generator [Jekyll](https://github.com/jekyll/jekyll) and published via the URL: **https://creaturesoftheholocene.com/**
